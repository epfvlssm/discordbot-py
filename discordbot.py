        ...
        await message.channel.send(f'보라색 상자를 열자…… 안에 들어있던 것은…! <{dice_result}>입니다.', reference=message) # 답장 o        
         ...
         await message.channel.send(embed=embed, reference = message)
          ...
          if SasaNum == 0:
            ...
            Text = '골동품점'
            Text2 = '오래된 물건들을 구경할 수 있는 곳이야. 여기 있는 물건들은 전부 어느 정도 가치가 있는 물건들이래. 이 안에서 너만의 보물을 찾을 수 있을까? 가구점 방문 기념으로 **골동품점 띠부씰**을 얻었어.'
          ...
          if QuestNum == 0:
            ...
            Text = '[카두케우스 퀘스트-2] 아기폼폼 요람 옮기기 (0/50)'
            ...
            Text = '[카두케우스 퀘스트-3] 케우스의 리본 빨래하기 (0/1)'
            ...
            Text = '[카두케우스 퀘스트-4] 카두스의 리본 수선하기 (0/1)'
            ...
            Text = '[카두케우스 퀘스트-5] 식물원에서 아기폼폼 채집하기 (0/100)'
            ...
            Text = '[카두케우스 퀘스트-6] 케우스에게 줄 케우스 인형 만들기(0/1)'
